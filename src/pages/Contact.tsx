            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              ...
              <div className="bg-white p-8 rounded-lg shadow-md">
                ...
                <form className="space-y-4">
                  ...
                  <button type="submit" className="w-full bg-blue-500 text-white p-3 rounded-lg font-semibold hover:bg-blue-600 transition duration-300">Send Message</button>
                </form>
              </div>
                ...
                <div className="space-y-4">
                  <p className="flex items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 mr-2 text-blue-500" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                      ...
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 6 0 0 0 6 6h2a3 3 0 11-6 0z" />
                    </svg>
          ...
          <div className="container mx-auto text-center">
            ...
            <div className="w-full h-full">
              ...
              <iframe
                ...
                src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d12626.505597105263!2d-122.05867690244749!3d37.39472412938045!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x808fb5e5bfb941ef%3A0x838b36034b6f6b13!2s123%20Tech%20Street%2C%20Silicon%20Valley!5e0!3m2!1sen!2sus!4v1616546769234!5m2!1sen!2sus"
                allowFullScreen
                loading="lazy"
              ></iframe>
            </div>
